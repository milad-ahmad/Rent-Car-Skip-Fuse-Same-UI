//
//  RentalDataService.swift
//  auto-complex-skip-app
//
//  Created by Milad Ahmad on 17/04/2026.
//
...
public class RentalDataService {
    ...
    public func fetchMockData() -> (dealers: [DealerLocation], cars: [Car], user: UserProfile) {
        ...
        let dealers = [dealer1, dealer2, dealer3]
