...
/**
 * A map view that displays nearby cars and dealer locations.
 * Includes fallback UI for Android where MapKit is not available.
 */
public struct MapExplorerView: View {
    ...
    @State public var isStandardStyle = true
    
    public var currentMapStyle: MapStyle {
