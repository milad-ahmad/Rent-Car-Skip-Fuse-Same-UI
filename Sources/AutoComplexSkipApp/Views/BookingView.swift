...
/**
 * View for managing the booking process of a rental car.
 */
public struct BookingView: View {
    let car: Car
    let selectedColor: CarColor
    let selectedInsurance: InsuranceOption?
    @Environment(RentalViewModel.self) var viewModel
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        VStack(spacing: 12) {
                            DatePicker("Pickup Date", selection: $startDate, displayedComponents: .date)
    ...
    /**
     * Applies the entered promotional code if valid.
     */
    ...
    /**
     * Processes the booking and updates the user's rental history.
     */
